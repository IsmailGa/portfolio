  ...
  <footer id="contact" class="pt-20 sm:pt-28 pb-16 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 border-t border-[#162436] bg-[#0A1118]/90 relative overflow-hidden">
    ...
    <div class="max-w-4xl mx-auto text-center flex flex-col items-center">
      ...
      <div class="mt-8 flex flex-col xs:flex-row items-stretch xs:items-center justify-center gap-3 sm:gap-4 w-full sm:w-auto">
        ...
        <button
          type="button"
          class="group relative inline-flex items-center justify-center gap-3 px-7 py-3.5 sm:py-4 rounded-xl bg-[#39C5BB] hover:bg-[#6FF7EC] text-[#05080D] font-mono font-bold text-xs sm:text-sm tracking-wider glow-teal hover:glow-teal-lg transition-all duration-200 cursor-pointer shadow-lg focus:outline-none"
          @click="copyEmail"
        ...
        <a
          ...
          target="_blank"
          rel="noopener"
          class="group inline-flex items-center justify-center gap-2 px-6 py-3.5 sm:py-4 rounded-xl bg-[#0E1724] border border-[#162436] hover:border-[#39C5BB] text-[#EAF7F6] hover:text-[#6FF7EC] font-mono font-medium text-xs sm:text-sm tracking-wider transition-all duration-200 cursor-pointer focus:outline-none"
      ...
      <div class="mt-8 sm:mt-10 flex flex-wrap items-center justify-center gap-2.5 sm:gap-3 max-w-2xl w-full">
        ...
        <button
          type="button"
          class="inline-flex items-center gap-2 px-3.5 py-2 rounded-lg bg-[#05080D] border border-[#162436] hover:border-[#39C5BB]/50 text-xs font-mono text-[#EAF7F6] hover:text-[#6FF7EC] transition-all cursor-pointer focus:outline-none"
          @click="copyPhone"
          @mouseenter="soundManager.playHover()"
        >
        ...
        <a
          ...
          target="_blank"
          rel="noopener"
          class="inline-flex items-center gap-2 px-3.5 py-2 rounded-lg bg-[#05080D] border border-[#162436] hover:border-[#39C5BB]/50 text-xs font-mono text-[#EAF7F6] hover:text-[#6FF7EC] transition-all focus:outline-none"
          @mouseenter="soundManager.playHover()"
        >
      ...
      <div class="mt-8 flex items-center justify-center gap-3 font-mono text-xs text-[#7C9399]">
        <div class="flex items-center gap-1.5 px-3 py-1 rounded-md bg-[#05080D] border border-[#162436]">
          ...
          <span>{{ t.contact.tashkentTime }}</span>
      ...
      <div class="mt-12 pt-6 border-t border-[#162436] w-full flex flex-col sm:flex-row items-center justify-between gap-3 text-xs font-mono text-[#7C9399]">
        ...
        <div class="flex items-center gap-2">
          <span>{{ t.contact.designMotif }}</span>
